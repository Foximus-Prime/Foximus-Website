...
class Session
{
   ...
   function checkLogin(){
      ...
      if(isset($_SESSION['username']) && isset($_SESSION['UserID']) &&
         ...
         $this->userlevel = $this->userinfo['Permisions'];
         return true;
      }
      /* User not logged in */
      else{
   ...
   function login($subuser, $subpass, $subremember){
	  ...
	  $q = "SELECT Pass FROM user WHERE Name = '$subuser'";
      $result = mysql_query($q, $database->connection);
      /* Retrieve password from result, strip slashes */
      $dbarray = mysql_fetch_array($result);
      $dbarray['Pass'] = stripslashes($dbarray['Pass']);
	  $q="SELECT AES_DECRYPT('".$dbPassHolder."', '".$subuser.$this->salt."') AS output";
      ...
      $this->username  = $_SESSION['username'] = $this->userinfo['Name'];
