...
<![endif]-->';
	...
	// The ?fin20 part of this link is just here to make sure browsers don't cache it wrongly.
	echo '
	<link rel="stylesheet" type="text/css" href="', $settings['theme_url'], '/css/960.css?fin20" />';
...
function template_body_below()
{
	...
	<div id="footer_section"><div class="frame">
		<ul class="reset">
			...
			<li><a id="button_xhtml" href="http://validator.w3.org/check?uri=referer&amp;charset=%28detect+automatically%29&amp;doctype=HTML5&amp;group=0" target="_blank" class="new_win" title="Valid HTML5!"><span>HTML5</span></a></li>
			<li><a id="button_css" href="http://jigsaw.w3.org/css-validator/check/referer?profile=css3" target="_blank" class="new_win" title="Valid CSS3!"><span>CSS3</span></a></li>
